...
public class ErrorResponse {
    ...
    public ErrorResponse(HttpStatus httpStatus, ErrorResponseFactory.InternalErrorCode errorCode, String devMessage, String langEnMessage, String langRuMessage) {
